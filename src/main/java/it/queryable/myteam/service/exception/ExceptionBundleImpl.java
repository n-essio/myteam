...
@ApplicationScoped
@Generated(value = "dev.queryable.QuexGenerator", date = "2023-11-07T09:52:29.601784691", comments = "don't touch please")
...
LanguageInterceptor languageInterceptor;
    ...
    @Override
    public QeexWebException msg_105() {
            // from annotation  @QeexMessage(id=105,code=500,message="name should not be empty")
            //this id IS AUTOMATICALLY GENERATED by method position inside interface
            int _id = 105;
            int _code = 500;
    ...
    @Override
    public QeexWebException msg_106(String name) {
            // from annotation  @QeexMessage(id=106,code=500,message="project name should be unique, given: %s")
            //this id IS AUTOMATICALLY GENERATED by method position inside interface
            int _id = 106;
            int _code = 500;
            String message = String.format("project name should be unique, given: %s",name);
            String language = languageInterceptor.getLanguage() != null? languageInterceptor.getLanguage() : "en";
            return QeexWebException.builder(qeexConfig.get_project(classProjectName))
                .id(_id)
                .code(_code)
